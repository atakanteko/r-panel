...
import { LocalStorageEnum, SystemKeysEnum } from 'types/enums/global-enums';
import {
...
function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  React.useEffect(() => {
    const { BORDER_RADIUS, COLOR_PRIMARY } =
  ...
  const memoizedSettings = React.useMemo(
    ...
    [overridableTokenItems, memoizedUpdateOverridableTokenItemsState]
  );
